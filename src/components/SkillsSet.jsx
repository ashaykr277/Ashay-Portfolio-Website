        ...
        <>
            <div className="info">
                ...
                <div className="right-side">
                    <h2 className='sub-heading'>My Skill-Set</h2>
                        ...
                        <div className='details details-left'>
                            ...
                            <div className='skill-container'>
                                ...
                                <div className="domain">
                                    ...
                                    <i class='bx bx-code' ></i><span>Front-end : </span>
                                    <p>HTML</p>
                                    <p>CSS</p>
                                    <p>JavaScript</p>
                                </div>
                            ...
                            <div className='skill-container'>
                                ...
                                <div className="domain">
                                    <i class='bx bx-code' ></i><span>DevOps : </span>
                                    <p>Git</p>
                                    <p>GitHub</p>
                                </div>
                            </div>
            ...
            <div className="skill-box">
                <div className='icon-packs'>
                    ...
                    <i class="devicon-hibernate-plain-wordmark colored"></i>
